...
// 叙事：能把 AI 做成业务结果 → 能建质量闭环 → 能沉淀方法论 → 能端到端交付
...
export const aiIntro = {
  ...
  narrative: [
    ...
    { source: "视觉质检运营中台（自建）", proof: "能建 AI 的质量闭环 · 评测集 · 人审台 · 样本回流" },
...
export const aiCapabilities = [
  ...
  },
  {
    layer: "Layer 02",
    name: "工程攻坚",
    desc: "输出稳定性、限流、并发、质量门。",
    evidence: "LLM 结构化输出治理 · VLM 按轮并行编排 · 超时与降级控制",
  },
  {
    layer: "Layer 03",
    name: "质量闭环",
...
export const aiProjects = [
  ...
  },
  {
    ...
    highlights: [
      ...
      "人工复核台与样本回流：难例沉淀为评测资产，形成越用越准的闭环",
  ...
  },
  {
    ...
    highlights: [
      "一人端到端交付：React 前端 + FastAPI 后端 + VLM 编排 + 埋点漏斗 + 云端部署",
      "证据页给出 AI 观察、判断依据与照片红框定位——让 AI 的判断可被验证",
      "质量门拦截模糊/无效照片，支持部分检测与补拍，产品规则兜住模型不确定性",
    ],
    link: "",
    linkLabel: "",
  },
